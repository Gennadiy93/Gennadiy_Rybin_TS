...
1. Клонируйте репозиторий с проектом с помощью команды: git clone https://github.com/Gennadiy93/Gennadiy_Rybin_TS.git
...
6. Установите инструмент allure на компьютер использую команду scoop install allure для Windows
